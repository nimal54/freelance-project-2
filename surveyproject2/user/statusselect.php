...
$sessionusername=$_SESSION['sessionuser']; // store session data
$del_id=0;
$i=0;
?>
 ...
 <th>Del</th> 
  ...
  // $i=0;
   echo "<tbody>";
        ...
        $sql4= "SELECT * FROM $table WHERE Username = '$sessionusername' ";
...
$row2 =mysqli_fetch_array($result2);
			...
			<td><a href='update.php?id=$id'onclick='return rem2()'>Update</a></td>
